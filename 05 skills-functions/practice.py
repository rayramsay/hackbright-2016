...
def sign_and_parity(integer):
    ...
    # the doctest requires parity before sign, weirdly
    ...
    if integer > 0:
        ...
        print "Zero has no sign."
        sign_and_parity.append("")
        # appending an empty string so that list will still have two items
